...
public class Registo extends AppCompatActivity {
    private EditText et_nome, et_email, et_password, et_cpassword;
    private String nome, email, password, cpassword;
    ...
    public void create_user(final View v)
    {
        auth.createUserWithEmailAndPassword(email , password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task)
            {
                ...
                if(task.isSuccessful())
                {
                    ...
                    ClienteAtleta cliente_novo = new ClienteAtleta(nome, email, password); //Crio um novo utilizador com os dados inseridos
                    //pelo utilizador na página Registo
